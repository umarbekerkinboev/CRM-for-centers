    ...
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a] flex flex-col items-center justify-center relative font-sans">
      ...
      <div className="absolute top-0 left-0 right-0 p-6 flex justify-between items-center">
        <div className="flex items-center gap-2">
          <svg width="32" height="38" viewBox="0 0 40 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="fill-zinc-900 dark:fill-white">
          ...
          <div className="flex flex-col">
            <span className="text-xl font-bold text-zinc-900 dark:text-white leading-none tracking-wide">KINGSTON</span>
            <span className="text-xs text-zinc-600 dark:text-white font-light tracking-wide mt-1">learning center</span>
          </div>
        </div>
